...
import 'package:givt_app_kids/widgets/visibility_tracker.dart';
import 'package:givt_app_kids/widgets/visibility_tracker.dart' as inner_widgets;
...
class _WalletScreenV3State extends State<WalletScreenV3>
  ...
  @override
  void onChanged(inner_widgets.Visibility visibility) {
    if (visibility == inner_widgets.Visibility.visible) {
      _updateProfiles();
    }
  }
