    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Positioned(
            bottom: -5,
            child: SvgPicture.asset('assets/images/coin_searching_shadow.svg'),
          ),
          Positioned(
            child: Stack(
              children: [
                Opacity(
                  ...
                  child:
                      SvgPicture.asset('assets/images/search_coin_state_1.svg'),
                ),
                Opacity(
                  opacity: 1 - animation.value,
                  child:
                      SvgPicture.asset('assets/images/search_coin_state_2.svg'),
                ),
              ],
            ),
          ),
